...
void FGNasalSys::init()
{
    ...
    // Now load the various source files in the Nasal directory TODO: the path should be based on fg-root and not just ../data!
    simgear::Dir nasalDir(SGPath(SGPath("../data"), "Nasal"));
