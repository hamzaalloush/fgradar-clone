...
FGRadarApplication::FGRadarApplication( int argc, char ** argv ) :
  FGGLApplication( "FGRadar", argc, argv )
{
...
void FGRadarApplication::Key( unsigned char key, int x, int y )
{
  switch( key ) {
    case 0x1b:
      exit(0);
...
double FGRadarApplication::Sleep()
{
